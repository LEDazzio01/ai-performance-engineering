...
Usage:
    python scripts/validate_imports.py              # Validate all
    python scripts/validate_imports.py --chapter 7  # Validate ch7 only
    python scripts/validate_imports.py --verbose    # Show successful imports too
"""
