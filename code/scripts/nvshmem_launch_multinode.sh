...
#
# Usage:
#   ./scripts/nvshmem_launch_multinode.sh <nodes> <gpus_per_node> [binary] [args...]
#
# Example:
#   ./scripts/nvshmem_launch_multinode.sh 2 8 ./ch4/nvshmem_multinode_example --gpus-per-node 8
#
