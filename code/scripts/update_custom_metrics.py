...
Usage:
    ...
    python scripts/update_custom_metrics.py --chapter 7
    ...
    python scripts/update_custom_metrics.py --apply --file ch7/baseline_memory_access.py
    
    # Show files that need conversion to proper benchmarks
    python scripts/update_custom_metrics.py --show-standalone
"""
    ...
    if args.apply or args.file:
        ...
        if can_improve or standalone:
            ...
            if can_improve:
                ...
                print("  python scripts/update_custom_metrics.py --apply")
                print()
            if standalone:
                print("To see standalone scripts that need conversion:")
                print("  python scripts/update_custom_metrics.py --show-standalone")
                print()
            print("To see a suggestion for a specific file:")
            print("  python scripts/update_custom_metrics.py --show-suggestion ch7/baseline_memory_access.py")
        
        print()
        print("To validate metric quality:")
        print("  python scripts/update_custom_metrics.py --validate")
