...
def get_chapter_name(ch_id: str) -> str:
    ...
    chapter_names = {
        "ch01": "Performance Basics",
        "ch02": "Hardware Overview",
        "ch03": "Infrastructure and OS Tuning",
        "ch04": "CUDA Basics",
        "ch05": "Memory Optimization",
        "ch06": "Instruction-Level Parallelism",
        "ch07": "GEMM and Batching",
        "ch08": "Double Buffering and Streams",
        "ch09": "Occupancy and Warp Divergence",
