...
Usage:
    python scripts/benchmark_coverage.py              # Full report
    python scripts/benchmark_coverage.py --json       # JSON output
    python scripts/benchmark_coverage.py --markdown   # Markdown output
"""
