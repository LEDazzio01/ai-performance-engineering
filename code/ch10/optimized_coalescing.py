"""optimized_coalescing.py - Coalesced memory access (optimized).
...
from common.python.memory_kernels import coalesced_copy
...
if __name__ == '__main__':
    ...
    print(f"\nOptimized Coalescing (Coalesced): {result.timing.mean_ms if result.timing else 0.0:.3f} ms")
