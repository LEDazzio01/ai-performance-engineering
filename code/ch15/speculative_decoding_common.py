"""Shared helpers for the speculative-decoding chapter benchmarks (ch15)."""
...
def default_workload(*, dtype: torch.dtype = torch.bfloat16) -> SpecDecodingWorkload:
    """Return the default speculative-decoding workload for chapter 15 benchmarks."""
