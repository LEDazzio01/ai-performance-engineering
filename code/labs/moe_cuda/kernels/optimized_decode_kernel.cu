...
// NOTE: TMEM is specifically for Tensor Core MMA accumulators, not general
// memory copies. The SM100_TMEM_STORE/LOAD traits move data to/from MMA
// accumulator registers, not arbitrary memory. Use TMA for async data movement.
...
__global__ void tma_decode_kernel(
    ...
    for (int chunk = 0; chunk < num_chunks; ++chunk) {
        ...
        // Use TMA bulk store for aligned tiles
