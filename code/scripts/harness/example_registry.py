...
def _discover_cuda_examples(existing_names: Optional[Iterable[str]] = None) -> List[Example]:
    # scripts/ is now in code/, so __file__ is .../code/scripts/example_registry.py
...
EXAMPLES: List[Example] = [
    ...
    _example(
        ...
        path="ch3/bind_numa_affinity.py",
    ...
    _example(
        ...
        path="ch4/before_dataparallel.py",
    ...
    _example(
        ...
        path="ch4/before_reinit_comm.py",
    ...
    _example(
        ...
        path="ch5/gpudirect_storage_example.py",
    ...
    _example(
        ...
        path="ch5/storage_io_optimization.py",
    ...
    _example(
        ...
        path="ch7/memory_access_pytorch.py",
    ...
    _example(
        name="ch7_vectorized",
        path="ch7/vectorized_pytorch.py",
    ...
    _example(
        ...
        path="ch8/warp_divergence_pytorch.py",
    ...
    _example(
        ...
        path="ch18/flexdecoding_example.py",
